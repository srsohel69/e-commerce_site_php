	...
	if(isset($_POST['add'])){
		...
		if(isset($_POST['catagory'])==true){
			...
			if($catagory=='Men'){
				...
				if (!mysqli_query($conn ,"insert into men(P_M_Code,P_M_Catagory,P_M_Brand,P_M_Price,P_M_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
				...
				if (!mysqli_query($conn ,"insert into women(P_W_Code,P_W_Catagory,P_W_Brand,P_W_Price,P_W_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into kids(P_K_Code,P_K_Catagory,P_K_Brand,P_K_Price,P_K_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into computer(P_C_Code,P_C_Catagory,P_C_Brand,P_C_Price,P_C_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into computer_accessory(P_CA_Code,P_CA_Catagory,P_CA_Brand,P_CA_Price,P_CA_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into mobile(P_Mo_Code,P_Mo_Catagory,P_Mo_Brand,P_Mo_Price,P_Mo_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into electronics(P_E_Code,P_E_Catagory,P_E_Brand,P_E_Price,P_E_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
				...
				if (!mysqli_query($conn ,"insert into others(P_O_Code,P_O_Catagory,P_O_Brand,P_O_Price,P_O_Quantity) values('$P_Code','$P_Cata','$P_brand','$P_price','$P_quantity')")){
					echo("Error.Item hasn't been added");
				}
				else {
					echo "Item has been added";
